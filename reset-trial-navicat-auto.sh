...
# Done
echo "Done."
# sean:~/git/node-utils/src/utils/sh$ chmod +x reset-trial-navicat-auto.sh 
# @reboot /home/sean/git/node-utils/src/utils/sh/reset-trial-navicat-auto.sh
# crontab -e
# @reboot /path/to/reset-trial-navicat-auto.sh
